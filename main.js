...
const geometry = new THREE.TorusGeometry(4.123, 0.9999, 30,100);
...
const textureCube = loader.load('ajay.jpeg');

const jeff = new THREE.Mesh(new THREE.BoxGeometry(1, 1, 1), new THREE.MeshBasicMaterial({map: textureCube }));
